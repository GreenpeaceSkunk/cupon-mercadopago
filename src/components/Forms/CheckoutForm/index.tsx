...
const Component: React.FunctionComponent<{}> = memo(() => {
  ...
  return useMemo(() => (
    ...
    >
      <Shared.Form.Header>
        <Elements.HGroup>
          <Shared.Form.Title>{appData && appData.layout.form.checkout.title}</Shared.Form.Title>
        </Elements.HGroup>
        <Shared.General.Text>{appData && appData.layout.form.checkout.text}</Shared.General.Text>
      </Shared.Form.Header>
      <Shared.Form.Content>
        <Shared.Form.Row>
      ...
      <Shared.Form.Nav>
        <Elements.Button
          ...
          customCss={css`
            ...
            `}
          `}
        >{(submitting) ? <Shared.Loader mode='light' /> : (appData && appData.layout.form.checkout.button_text)}</Elements.Button>
      </Shared.Form.Nav>
    </Shared.Form.Main>
  ), [
    formRef,
